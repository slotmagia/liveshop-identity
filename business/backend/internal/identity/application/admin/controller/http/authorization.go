...
import (
	"context"
	api "github.com/lvtuopen-ai/liveshop-identity/business/backend/internal/identity/application/admin/api/http/v1/authorization"
...
type AuthorizationController struct{ s service.Admin }

func NewAuthorization(s service.Admin) *AuthorizationController {
...
func (c *AuthorizationController) PutPolicy(ctx context.Context, r *api.PutPolicyReq) (*api.PutPolicyRes, error) {
	...
	out := api.PutPolicyRes(wireRole(v))
	return &out, nil
}
...
func wireRole(r appmodel.Role) api.Role {
