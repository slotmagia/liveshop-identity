...
type ListReq struct {
	g.Meta          `path:"/aftersales" method:"get" tags:"Identity-merch"`
...
type GetReq struct {
	g.Meta      `path:"/aftersales/{aftersaleId}" method:"get" tags:"Identity-merch"`
...
type ReviewReq struct {
	g.Meta          `path:"/aftersales/{aftersaleId}/review" method:"post" tags:"Identity-merch"`
	AftersaleId     int64  `json:"aftersaleId" in:"path"`
...
type CreateReturnReq struct {
	g.Meta          `path:"/aftersales/{aftersaleId}/returns" method:"post" tags:"Identity-merch"`
	AftersaleId     int64  `json:"aftersaleId" in:"path"`
	CommandKey      string `json:"commandKey"`
	ExpectedVersion uint64 `json:"expectedVersion"`
}

type CreateReturnRes struct {
	Aftersale Aftersale `json:"aftersale"`
	Replayed  bool      `json:"replayed"`
}
